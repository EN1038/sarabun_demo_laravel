...
@section('home1')
    <div class="row">
        ...
        <div class="col-md-4 mt-4 p-3 rounded lh-1" style="background-color: #f1f1f1; overflow:auto; max-height: 83vh;">
            ...
            <form>
                <div class="mb-1 row">
                    <label for="registrationBook" class="col-sm-2 col-form-label text-end">สมุดทะเบียน</label>
                    ...
                    <div class="col-sm-3">
                        <input type="text" class="form-control" id="numberReceive" name="numberReceive"
                            placeholder="เลขที่รับ" readonly>
                    </div>
                </div>
                <hr>
                <div class="mb-1 row">
                    ...
                    <div class="col-sm-3 position-relative">
                        <input type="text" class="form-control" id="bookNumberDetail" name="bookNumberDetail"
                            placeholder="เลขมั้ง">
                        <span class="text-danger position-absolute fw-bold"
                            style="top: 10%; right: 5px; transform: translateY(-50%);">*</span>
                    </div>
                ...
                <div class="mb-1 row">
                    <label for="receivedDate" class="col-sm-2 col-form-label text-end">วันที่ได้รับ</label>
                    <div class="col-sm-3">
                        <input type="date" class="form-control" id="receivedDate" name="receivedDate"
                            placeholder="วันที่ได้รับ">
                    </div>
                    <label for="receivedDateInput" class="col-sm-2 col-form-label text-end">วันที่รับ</label>
                    <div class="col-sm-3">
                        <input type="date" class="form-control" id="receivedDateInput" name="receivedDateInput"
                ...
                <div class="mb-1 row">
                    <label for="registrationDate" class="col-sm-2 col-form-label text-end">ลงวันที่</label>
                    <div class="col-sm-5 position-relative">
                ...
                <div class="mb-1 row">
                    ...
                    <!-- Modal -->
                    <div class="modal fade" id="staticBackdropx" data-bs-backdrop="static" data-bs-keyboard="false"
                ...
                <hr>
                <div class="mb-1 row">
                    <label for="registrationBook" class="col-sm-2 col-form-label text-end">หมายเหตุ</label>
                    <div class="col-sm-3">
        ...
        <div class="col-md-6">
            <ul class="nav nav-tabs" id="myTab2" role="tablist" style="justify-content: flex-end;">
                <li class="nav-item" role="presentation">
                    <a class="nav-link active" id="home-tab2" data-bs-toggle="tab" href="#home2" role="tab"
                        aria-controls="home2" aria-selected="true">หนังสือรับ</a>
                </li>
                <li class="nav-item" role="presentation">
                    <a class="nav-link" id="profile-tab2" data-bs-toggle="tab" href="#profile2" role="tab"
                        aria-controls="profile2" aria-selected="false">สิ่งที่ส่งมาด้วย</a>
                </li>
                <li class="nav-item" role="presentation">
                    <a class="nav-link" id="settings-tab2" data-bs-toggle="tab" href="#settings2" role="tab"
                        aria-controls="settings2" aria-selected="false">อ้างถึง</a>
                </li>
            </ul>
